...
impl AccountsDb {
    ...
    pub(crate) fn combine_ancient_slots_packed(
        ...
        log::error!(
            "combine_ancient_slots_packed: dead_accounts_pending: number of slots {:#?}",
    ...
    fn combine_ancient_slots_packed_internal(
        ...
        log::error!(
            "combine_ancient_slots_packed_internal: best_slots_to_shrink number {:#?}",
            ancient_slot_infos.best_slots_to_shrink.len()
        );
        std::mem::swap(
    ...
    fn write_ancient_accounts<'a, 'b: 'a>(
        ...
        log::error!(
            "write_ancient_accounts: bytes {:#?}, target_slot {:#?}",
            bytes,
            target_slot
        );
    ...
    fn write_packed_storages<'a, 'b>(
        ...
        log::error!(
            "write_packed_storages: accounts_to_combine: number of {:#?}",
